...
public class E2Books {
    ...
    public E2Books(String bookTitle,String bookAuthor,String ISBN,int numberOfPages,boolean available,String borrowDate,String returnDate){
