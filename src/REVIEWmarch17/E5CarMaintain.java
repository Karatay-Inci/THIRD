...
public class E5CarMaintain {
    ...
    public E5CarMaintain(String carName, int odometerCurrent, int odometerNextOilChange, String airFilterStatus, String cabinFilterStatus, String oilFilterStatus) {
