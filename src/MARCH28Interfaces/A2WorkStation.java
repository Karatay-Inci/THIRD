...
public class A2WorkStation extends A2Computer implements A2Computers{
    private String housingType;
    private int screenSize;

    public A2WorkStation(String[] mainBoardSpecs, int memorySize, int cpuSpeed, String cpuType, String housingType, int screenSize) {
